...
- 🎯 Use core stack manipulation words: `dup`, `drop`, `swap`, `over`, `rot`
- 🎯 Mentally trace complex stack operations without running code
- 🎯 Choose the right stack word for any data rearrangement task
- 🎯 Understand how stack manipulation compares to variable assignment in other languages
- 🎯 Recognize stack manipulation patterns that lead to cleaner code
- 🎯 Debug stack underflow and overflow errors
