...
- 🎯 Use boolean values and understand Forth's true (-1) and false (0) convention
- 🎯 Write conditional logic using `IF...THEN...ELSE` structures
- 🎯 Apply comparison operators (`=`, `<`, `>`, etc.) effectively
- 🎯 Combine conditions with logical operators (`AND`, `OR`, `XOR`, `INVERT`)
- 🎯 Implement multi-way branching with `CASE...ENDCASE`
- 🎯 Understand how Forth conditionals relate to if-statements in C/Python/Java
- 🎯 Recognize how boolean flags work at the bit level
